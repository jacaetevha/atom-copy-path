...
module.exports = {
  ...
  getTargetEditorPath(e) {
    ...
    if (!this.ignorePath) {
      ...
      return item.getPath ? item.getPath().replace(this.ignorePath, "") : "";
    }
  },
  ...
  copyAfterPath(e) {
    ...
    console.log("result-prefix: " + result.split(this.ignorePath)[1]);
    this.writeToClipboardIfValid(result.split(this.ignorePath)[1]);
  },
